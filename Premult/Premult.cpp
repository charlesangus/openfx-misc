...
#define kParamProcessRHint  " the red channel."
#define kParamProcessGHint  " the green channel."
#define kParamProcessBHint  " the blue channel."
#define kParamProcessAHint  " the alpha channel."
